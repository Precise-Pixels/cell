<main>
    ...
    <section>
        <div class="section-padding align-centre lgrey">
            <h1><div class="ico-company"></div>THE COMPANY</h1>
    ...
    <section>
        <div class="section-padding align-centre lgrey">
            <h1><div class="ico-key-people"></div>KEY PEOPLE</h1>
    ...
    <section>
        <div class="section-padding align-centre sdgrey">
            <h1 class="timeline-header"><div class="ico-calendar"></div>TIMELINE</h1>
        </div>
